...
data <- read_excel("C:/tugas kuliah el/NSC-2025.xlsx", sheet="Sheet2")
...
$$\hat{Y} = 109.1188 - 0.4662119 X_8$$

dengan Y adalah Indeks Pembangunan Manusia dan X8 adalah Tingkat Partisipasi Angkatan Kerja.

Didapatkan nilai $\hat\beta_0 = 109.1188$ artinya nilai dugaan rataan indeks pembangunan manusia ketika Tingkat Partisipasi Angkatan Kerja bernilai 0 persen adalah 109.1188%, akan tetapi nilai 0 tidak ada dalam selang pengamatan Tingkat Partisipasi Angkatan Kerja sehingga $\hat\beta_0$ tidak dapat didefinisikan lebih lanjut

Nilai $\hat\beta_1 = -0.4662119$ artinya nilai dugaan perubahan dugaan rataan Indeks Pembangunan Manusia jika Tingkat Partisipasi Angkatan Kerja berubah satu persen adalah berkurang sebesar 0.4662119%

Koefisien determinasi yang dihasilkan adalah 0.1818007 atau 18.18% artinya keragaman persentase Indeks Pembangunan Manusia yang dapat dijelaskan oleh Tingkat Partisipasi Angkatan Kerja adalah sebesar 18.18%, sisanya yaitu 81.82% dijelaskan oleh peubah lain yang tidak dimasukkan dalam model.
